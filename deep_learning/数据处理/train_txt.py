...
segfilepath=r'D:/python_study/process_data_yangjie'
saveBasePath=r"D:/python_study/data"

sets = ['seg_dect_train', 'seg_dect_val', 'seg_dect_test']

classes = ["bc", "blj", "dlj", "fzcz", "hkmj","hqc","pbc", "qt", "qxyj", "qzj", "xlj", "yc", "yt"]
...
list_file = open('D:/python_study/data/seg_dect_train.txt', 'w')
...
list_file = open('D:/python_study/data/seg_dect_val.txt', 'w')
...
list_file = open('D:/python_study/data/seg_dect_test.txt', 'w')
...
list_file = open('D:/python_study/data/seg_dect_trainval.txt', 'w')
